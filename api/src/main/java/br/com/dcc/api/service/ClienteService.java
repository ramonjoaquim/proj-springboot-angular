...
import br.com.dcc.api.repository.IClienteService;
...
public class ClienteService implements IClienteService {
    ...
    public ValidationResult delete(long id) {
        ...
        try {
            optionalCliente.orElseThrow(() -> new ExceptionNotFound("Cliente não encontrado com id: " + id));
    ...
    private Cliente getCliente(long id) {
        Optional<Cliente> optionalCliente = repository.findById(id);
        return optionalCliente.orElseThrow(() -> new ExceptionNotFound("Cliente não encontrado com id: " + id));
    }
    ...
    private ValidationResult validaEndereco(Cliente cliente){
        ...
        long enderecoPrincipal = cliente.getEnderecos().stream()
    ...
    private Cliente toEntity(Cliente cliente) {
    ...
    private ValidationResult validaEnderecoCampos(Cliente cliente){
        for (Endereco endereco : cliente.getEnderecos()) {
            if (endereco.getRua().isBlank() || endereco.getRua().isEmpty())
